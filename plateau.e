...
feature -- Operations
	...
	afficher_carte_centre (a_controlleur_jeu: GAME_LIB_CONTROLLER; image_carte: GAME_SURFACE_IMG_FILE)
		local
			l_endos:GAME_SURFACE_IMG_FILE
		do
			l_endos := image_carte_endos
			l_endos.rotate_90_degree (1)
			image_carte.rotate_90_degree (1)
			a_controlleur_jeu.screen_surface.draw_surface (image_carte_endos, 380, 315)
			a_controlleur_jeu.screen_surface.draw_surface (image_carte, 380, 415)
		end
