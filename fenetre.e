note
	description: "Classe pour la fenêtre du jeu"
...
feature -- Operations
	...
	set_image_affichee_avec_lien (a_lien_image: STRING)
		...
		do
			image_affichee:= create {GAME_SURFACE_IMG_FILE}.make (a_lien_image)
		end
